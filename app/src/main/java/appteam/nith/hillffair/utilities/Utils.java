...
// code to add cache in retrofit
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl("https://api-hillfair-2k16.herokuapp.com/api/app/").addConverterFactory(GsonConverterFactory.create()).client(PrefetchingLib.getOkHttp(oBuilder.build())).build();
